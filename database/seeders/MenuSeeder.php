...
class MenuSeeder extends Seeder
{
    ...
    public function run(): void
    {
        DB::table('menus')->insert([
            ...
            ['id' => 5, 'parent_id' => NULL, 'module_id' => 1, 'menu_name' => 'Rastreamento', 'slug' => '', 'order_priority' => 4, 'route' => 'processos.rastreamento', 'icon' => 'fas fa-shipping-fast', 'position' => 'VERTICAL', 'description' => NULL, 'created_at' => now(), 'updated_at' => now()],
            ['id' => 6, 'parent_id' => NULL, 'module_id' => 1, 'menu_name' => 'Autorizações', 'slug' => '', 'order_priority' => 5, 'route' => 'processos.autorizar', 'icon' => 'fas fa-user-check', 'position' => 'VERTICAL', 'description' => NULL, 'created_at' => now(), 'updated_at' => now()],
            ['id' => 7, 'parent_id' => NULL, 'module_id' => 1, 'menu_name' => 'DU Automático', 'slug' => '', 'order_priority' => 6, 'route' => 'processos.du', 'icon' => 'fas fa-cogs', 'position' => 'VERTICAL', 'description' => NULL, 'created_at' => now(), 'updated_at' => now()],
